...
class Document:
    def __init__(self, self_id: int, category_id: int, topic_id: int, file_name: str):
        self.id = self_id
    ...
    @classmethod
    def from_instances(cls, self_id: int, category: Category, topic: Topic, file_name: str):
        return cls(self_id, category.id, topic.id, file_name)
